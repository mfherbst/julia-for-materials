...
# ╔═╡ fce80334-c7ad-4208-836d-4e7f78b03663
begin
	using ASEconvert
	using AtomsIO
	using AtomsIOPython
...
# ╔═╡ 9ae3be39-1b92-4239-8e94-acc752e81ce1
LocalResource("Logos.png")

# ╔═╡ 21c7ac3a-b94b-4aea-a137-9638de4cce21
md"# Atomistic modelling ecosystem (1/4)"

# ╔═╡ 2d512127-00b6-49a5-be34-b2e184802a30
md"""
## JuliaMolSim
...
For more information about the organisation, including a link to a private Zulip chat, see the [JuliaMolSim website](https://juliamolsim.github.io/).
"""

# ╔═╡ 581bd874-6d17-43bf-bd9b-074e17a8d1e1
md"## AtomsBase"

# ╔═╡ 9fda9c06-7ca4-4046-8a20-5e7c935f0083
md"""
[**AtomsBase**](https://github.com/JuliaMolSim/AtomsBase.jl) is an interface package, which allows other Julia packages to share atomistic structures with each other.

For example we construct a silicon supercell using **ASE** (the atomistic simulation environment). Using [**ASEconvert**](https://github.com/mfherbst/ASEconvert.jl) we expose the resulting *ASE.Atoms* object to Julia. 

$(@bind N PlutoUI.Slider(1:1:20; default=4, show_value=true))
"""

# ╔═╡ b4be035e-75df-43c6-ad44-d61f3b174e24
begin
	silicon_ase = ase.build.bulk("Si", cubic=true) * pytuple((N, 1, 1))
	silicon_supercell = pyconvert(AbstractSystem, silicon_ase)
end

# ╔═╡ 58d5cb8d-1e74-4b7c-bdcf-565512f27941
md"""
We already saw that [**DFTK**](https://dftk.org) can directly make use of AtomsBase structures. The visualisation you see now is done using [**AtomsView**](https://github.com/mfherbst/AtomsView.jl), which similarly is based on AtomsBase input.

Of note, this implies that both packages immediately work with *any package* providing AtomsBase-compatible data, e.g. [**AtomsIO**](https://github.com/mfherbst/AtomsIO.jl), which supports parsing / writing a plethora of file formats:
"""

# ╔═╡ e6e48368-b000-4c61-ae43-cc7762089e52
silicon_loaded = load_system("Si.extxyz")

# ╔═╡ 497f36f5-c5fc-4baf-a6d8-4aacd51ca55c
HTML(AtomsView.visualize_structure(silicon_loaded, MIME("text/html")))

# ╔═╡ 33efd544-87ed-4eaf-af6d-6c59829085d3
md"""
!!! danger "todo above"
"""

# ╔═╡ 52e70d6b-d4c5-4b2a-9440-2d26f0f3d5e4
let
...
# ╔═╡ f49dde16-97aa-41e8-a776-1926ad39ae2d
md"""
For other things you can do with AtomsBase see the [list of packages implementing the  AtomsBase interface](https://github.com/JuliaMolSim/AtomsBase.jl#packages-using-atomsbase). Unfortunately the ecosystem is still rapidly evolving and not all packages interoperate as flawlessly as desirable.

Note, that pretty much all of the packages we discuss in these notebooks are compatible with AtomsBase (e.g. [DFTK](https://dftk.org), [JuLIP](https://github.com/JuliaMolSim/JuLIP.jl/), [Molly](https://github.com/JuliaMolSim/Molly.jl)).
"""

# ╔═╡ 76596a49-f4e5-418a-84be-f261836f92fd
md"""## Molly 

[**Molly**](https://github.com/JuliaMolSim/Molly.jl) is a molecular dynamics simulator written in Julia. Similar to DFTK the focus is to make use of features of the Julia programming language, e.g. to yield differentiable MD simulations or GPU support.


As an example we consider a simple LJ setup with $(@bind n_atoms PlutoUI.Slider(20:10:100; default=100, show_value=true)) atoms:
"""

# ╔═╡ ad254c47-4155-448a-b2b2-f68c8e737b94
begin
	atom_mass = 10.0u"u"
...
# ╔═╡ 3c3c3f60-ebab-41df-9d93-76ec24adff35
simulator = VelocityVerlet(
    dt = 0.002u"ps",
    coupling = AndersenThermostat(temp, 1.0u"ps"),
);

# ╔═╡ 3ab03329-54be-421a-a7b7-4b1b2172f9c3
simulate!(sys, simulator, 1_000);

# ╔═╡ 50b9b95d-55d9-457f-83f6-9deae6f46def
begin
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "5a0268af66c6c8c79e9b455ef265ddf3511dcab7"
...
git-tree-sha1 = "ff862fc57fa5e159f19b3804b48e36ede43f6945"
...
git-tree-sha1 = "ff0afa4d7e66905d75e0266c85efe4083d116df0"
